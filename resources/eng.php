...
$ Normal solution = 'Answer for Normal Game Solution:'; // Solution is displayed for Normal Number, after this message.
$ Square solution = 'Answer for Square Game Solution:'; // Solution is displayed for Square Number, after this message.
